...
export default {
    IndexUrlNewGoods: NewApiRootUrl + 'index/newGoods', //首页新品首发
    ...
    TopicEnroll: NewApiRootUrl + 'topic/join', //参加活动
